...
static const string WINDOW_WIDTH_STR = "window_width"s;
static const string WINDOW_HEIGHT_STR = "window_height"s;
static const string WINDOW_MAXIMIZED_STR = "window_maximized"s;
...
void load()
{
    // Должно вызываться после инициализации SDL?
